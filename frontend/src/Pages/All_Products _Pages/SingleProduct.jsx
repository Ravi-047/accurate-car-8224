        ...
        <Flex w={"90%"} m="auto" gap={4}>
          <Box>
            <Grid templateColumns="repeat(2, 1fr)" gap={1}>
              <Image
                w="100%"
                h={"98%"}
                src="https://www.aeropostale.com/dw/image/v2/BBSG_PRD/on/demandware.static/-/Sites-master-catalog-aeropostale/default/dwa09905e3/86749439_007_main.jpg?sw=478&sh=557&sm=fit&sfrm=jpg"
                alt="1"
              />
              <Image
                w="100%"
          ...
          <Box w="40%">
            ...
            <Box display={"flex"} justifyContent="flex-start" gap={2}>
              <Text alignItems={"left"} fontSize={"20px"} fontWeight="bold">
                ${32.0}
              </Text>
                ...
                <AccordionPanel pb={4}>
                  <Box>
                    <Text color="black" fontWeight={"semibold"}>
                      An iconic style with plenty of urban attitude. Which coast
                      will you rep?
                    </Text>
                    <br />
                    <Text color="black" fontWeight={"semibold"}>
                    ...
                    <Text color="gray.600" fontWeight={"semibold"} ml={3}>
                      # Woven fabric
                    </Text>
                    <Text color="gray.600" fontWeight={"semibold"} ml={3}>
                      #Snap placket
                    ...
                    <Text color="gray.600" fontWeight={"semibold"} ml={3}>
                      #Front & back New York or Los Angeles California graphics
                    </Text>
                    <Text color="gray.600" fontWeight={"semibold"} ml={3}>
